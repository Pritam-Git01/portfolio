  ...
  return (
    ...
    >
      <div className="aspect-video bg-gray-200 dark:bg-gray-700 relative overflow-hidden">
            ...
            <div
              className={`w-full h-full flex flex-col items-center justify-center ${
                project.category === "ai/ml"
                  ? "bg-linear-to-br from-purple-500/20 via-indigo-500/15 to-blue-500/20 dark:from-purple-900/40 dark:via-indigo-800/30 dark:to-blue-900/40"
                  : project.category === "backend"
                    ? "bg-linear-to-br from-emerald-500/20 via-teal-500/15 to-cyan-500/20 dark:from-emerald-900/40 dark:via-teal-800/30 dark:to-cyan-900/40"
                    : "bg-linear-to-br from-blue-500/20 via-sky-500/15 to-indigo-500/20 dark:from-blue-900/40 dark:via-sky-800/30 dark:to-indigo-900/40"
              }`}
            >
              <svg
        ...
        <motion.div
          className="absolute top-0 left-0 w-full h-full bg-linear-to-b from-black/40 via-transparent to-black/70 flex items-end justify-center p-4"
      ...
      <div className="p-6">
        ...
        <motion.p
          className="text-gray-600 dark:text-gray-400 mb-4 text-sm line-clamp-3"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
