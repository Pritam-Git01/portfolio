        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
          ...
          >
            ...
            <div className="sm:flex hidden items-center">
              <div
                className="h-1 w-12 bg-blue-500 mr-4"
                aria-hidden="true"
              ></div>
            ...
            <p className="sm:text-lg text-base text-gray-600 dark:text-gray-400 max-w-lg">
              ...
              efficient code. Specializing in{" "}
              <strong>full-stack development</strong>,{" "}
              <strong>cloud architecture</strong>, and{" "}
              <strong>scalable web applications</strong> using{" "}
            ...
            <div className="mt-6 flex items-center">
              ...
              <p className="ml-4 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                {experienceText}+ years experience with modern technologies
              </p>
            </div>
            ...
            <div className="sr-only">
              ...
              Frontend Engineer, Backend Engineer, React Developer, Node.js
          ...
          >
            <div className="relative lg:block hidden w-full max-w-md mx-auto lg:mx-0 lg:max-w-none aspect-square">
              <div
                className="absolute inset-0 bg-linear-to-tr from-blue-500 to-purple-600 rounded-full opacity-10 blur-3xl"
                aria-hidden="true"
              ></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-full h-full max-w-[80%] max-h-[80%] rounded-full bg-gray-200 dark:bg-gray-800 overflow-hidden border-8 border-white dark:border-gray-700 shadow-xl">
